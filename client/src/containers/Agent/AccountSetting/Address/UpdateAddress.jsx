...
const UpdateAddress = (props) => {
  const { update, setUpdate, updateAdrs } = props
            ...
            <div>
              <div>
                ...
                <div className="form-group">
                  <div>
                    <label>
                      <input type="checkbox" checked={isCheck} disabled={updateAdrs?.isSelected ? true : false} onChange={e => setIsCheck(e.target.checked)} /> Đặt làm địa chỉ mặc định
                    </label>
                  </div>
                </div>
              </div>
